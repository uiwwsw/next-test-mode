...
<div class="actions"><button id="ssr-patch" type="button" aria-pressed="true">Patch · 일부 변경</button><button id="ssr-mock" type="button" aria-pressed="false">Mock · 전체 교체</button></div>
<form id="ssr-form"><label for="ssr-input">GET /api/cart.json · JSON</label><textarea id="ssr-input" spellcheck="false">{ "total": 12.34 }</textarea>
...
<p id="ssr-error" class="error" role="alert" hidden></p></form>
